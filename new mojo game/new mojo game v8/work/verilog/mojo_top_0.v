...
module mojo_top_0 (
  ...
  button_conditioner_5 spd_btn_up (
    .clk(clk),
    .in(M_spd_btn_up_in),
  ...
  button_conditioner_5 spd_btn_down (
    .clk(clk),
  ...
  button_conditioner_5 lth_btn_up (
    .clk(clk),
    .in(M_lth_btn_up_in),
  ...
  button_conditioner_5 lth_btn_down (
    .clk(clk),
  ...
  button_conditioner_5 start_btn (
    .clk(clk),
    .in(M_start_btn_in),
    .out(M_start_btn_out)
  );
  ...
  localparam INPUT2_game = 3'd3;
  localparam CHECK_game = 3'd4;
  localparam SCORE_game = 3'd5;
  ...
  always @* begin
    ...
    case (M_game_q)
      IDLE_game: begin
        ...
        M_score2_d = 1'h0;
        M_user_d = 1'h0;
        if (M_s_edgeup_out == 1'h1 && M_speed_q < 3'h4) begin
          M_speed_d = M_speed_q + 1'h1;
        end
        if (M_s_edgedown_out && M_speed_q > 1'h0) begin
          M_speed_d = M_speed_q - 1'h1;
        end
        if (M_l_edgeup_out == 1'h1 && M_length_q < 4'hf) begin
          M_length_d = M_length_q + 1'h1;
        end
        if (M_l_edgedown_out && M_length_q > 1'h0) begin
          M_length_d = M_length_q - 1'h1;
        end
