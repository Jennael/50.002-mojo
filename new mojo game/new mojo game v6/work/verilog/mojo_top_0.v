  ...
  always @* begin
    ...
    case (M_game_q)
      ...
      CHECK_game: begin
        ...
        if (M_check_address > 5'h05) begin
          M_check_calc = 1'h0;
          M_score_d[4+3-:4] = M_score_q[4+3-:4] + M_check_tens;
          M_score_d[0+3-:4] = M_score_q[0+3-:4] + M_check_ones;
          M_game_d = SCORE_game;
        end
      end
      SCORE_game: begin
        M_seg_values[12+7-:8] = {M_score_q[4+3-:4], M_score_q[0+3-:4]};
        red_led = 1'h1;
